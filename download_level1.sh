...
export temp_list=$GWS_PATH/S3A_test_data/tandem_data_S7_S8_tests/temp_filelist.txt

/usr/bin/python2.7 $GWS_PATH/software/slstr_calibration_ftp_retriever/data_retriever.py -c $GWS_PATH/software/slstr_calibration_ftp_retriever/config/slstr_cpa_tandem_s7_s8_level1.cfg -v -L -p RAL/S3MPC-3356/$process_date/$model > $temp_list

export date_directory=$GWS_PATH/S3A_test_data/tandem_data_S7_S8_tests/$process_date/$model/


export temp_config=$GWS_PATH/software/slstr_calibration_ftp_retriever/config/slstr_cpa_mpc_tandem_temp.cfg
export output_dir=$GWS_PATH/S3A_test_data/tandem_data_S7_S8_tests/
export temp_log_dir=$GWS_PATH/S3A_test_data/tandem_data_S7_S8_tests/
...
while read -r line; do 
   ...
   echo lockfile: $GWS_PATH/S3A_test_data/tandem_data_S7_S8_tests/lock_temp.txt>>$temp_config
   echo >>$temp_config
